const VieraKey = {
  ...
  num_0: 'NRC_D0-ONOFF',
  /** 11チャンネル */
  num_11: 'NRC_D11-ONOFF',
  /** 12チャンネル */
  num_12: 'NRC_D12-ONOFF',
  /** 元の画面 */
  ...
  tv: 'MACRO_TV-ONOFF',
  /** HDMI1 */
  hdmi1: 'MACRO_VIDEO-ONOFF',
  /** HDMI2 */
  hdmi2: 'MACRO_HDMI2-ONOFF',
  /** HDMI3 */
  hdmi3: 'MACRO_HDMI3-ONOFF',
  /** ビデオ */
  video: 'MACRO_HDMI4-ONOFF',
} as const;
type VieraKey = typeof VieraKey[keyof typeof VieraKey];
